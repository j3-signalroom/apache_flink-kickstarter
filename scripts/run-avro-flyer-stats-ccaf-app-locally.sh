...
#
# *** Script Syntax ***
# scripts/run-avro-flyer-stats-ccaf-app-locally.sh --profile=<AWS_SSO_PROFILE_NAME>
...
cd python_ccaf
poetry shell
poetry run avro_flyer_stats_ccaf_app --service-account-user $SERVICE_ACCOUNT_USER --aws-region $AWS_REGION
