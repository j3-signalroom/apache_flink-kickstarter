 ...
 * Tables, respectively.
 */
public class AvroDataGeneratorExtendedResourcesApp {
    private static final Logger LOGGER = LoggerFactory.getLogger(AvroDataGeneratorExtendedResourcesApp.class);
